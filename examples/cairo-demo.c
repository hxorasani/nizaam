...
hello_world()
{
    ...
    cairo_destroy (cr);
    cairo_surface_write_to_png (surface, "data/hello.png");
...
stroke()
{
    ...
    cairo_surface_write_to_png (surface, "data/stroke.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
fill()
{
	...
	/* Write output and clean up */
    cairo_surface_write_to_png (surface, "data/fill.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
show_text()
{
	...
	/* Write output and clean up */
	cairo_surface_write_to_png (surface, "data/showtext.png");
	cairo_destroy (cr);
	cairo_surface_destroy (surface);
}
...
paint()
{
	...
	/* Write output and clean up */
    cairo_surface_write_to_png (surface, "data/paint.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
mask()
{
	...
	/* Write output and clean up */
    cairo_surface_write_to_png (surface, "data/mask.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
set_sourcergba()
{
	...
	/* Write output and clean up */
    cairo_surface_write_to_png (surface, "data/setsourcergba.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
set_sourcegradient()
{
	...
	/* Write output and clean up */
    cairo_surface_write_to_png (surface, "data/setsourcegradient.png");
    cairo_destroy (cr);
    cairo_surface_destroy (surface);
}
...
void textextents()
{
	...
	/* Write output and clean up */
	cairo_surface_write_to_png (surface, "data/textextents.png");
	cairo_destroy (cr);
	cairo_surface_destroy (surface);
}
...
tipsfont()
{
	...
	/* Write output and clean up */
	cairo_surface_write_to_png (surface, "data/tips-font.png");
	cairo_destroy (cr);
	cairo_surface_destroy (surface);
}
