...
menu = {
	selected: 0,
	length: 0,
	visible: function () { return root.visible; },
	...
	toggle: function () {
		var h; // queue hide
		if (!root.visible) root.visible = 1;
		else h = 1;
		root.animate = {
			location: {
				x: {
...
//		if (root.visible) aud.play('/home/nano/Music/sci-fi/sound_ex_machina_Action - Closing Effect Sound.mp3');
	},
	keyboard: function (m) {
