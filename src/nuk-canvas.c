...
nk_bool
canvas_begin(struct nk_context *ctx, const char *name, struct nk_canvas *canvas, nk_flags flags,
...
static void
canvas00(struct nk_context *ctx)
{
        struct nk_canvas canvas;
        if (canvas_begin(ctx, "Canvas", &canvas, NK_WINDOW_BORDER|NK_WINDOW_MOVABLE|NK_WINDOW_SCALABLE|
